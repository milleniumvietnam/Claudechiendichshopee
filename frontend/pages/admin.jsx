    ...
    return (
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-paper-200 px-4">
          <form onSubmit={handleLogin} className="bg-white rounded-xl shadow-lift p-8 w-full max-w-md">
            <h1 className="font-display text-2xl font-bold text-ink mb-2">Admin Login</h1>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-volt"
              required
            />
            <button type="submit" className="w-full px-4 py-3 bg-ink text-white font-semibold rounded-lg hover:bg-volt">
              Đăng nhập
            </button>
      ...
      <div className="min-h-screen bg-gray-50">
        <nav className="bg-white border-b border-gray-100 sticky top-0 z-10">
          <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            <span className="font-display font-bold text-xl text-ink">Admin · Kinh Doanh Shopee</span>
            <div className="flex items-center gap-4 text-sm">
              <Link href="/" className="text-gray-600 hover:text-ink">Xem web</Link>
              <button
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          {msg && <p className="mb-4 text-sm font-medium text-ink">{msg}</p>}

          <div className="flex items-center justify-between mb-4">
            <h2 className="font-display text-xl font-bold text-ink">Sản phẩm & link affiliate</h2>
...
function ProductRow({ product, onSave }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-card p-4 flex flex-col md:flex-row md:items-center gap-3">
      ...
      <input
        ...
        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-volt"
      />
      ...
      <button
        ...
        className="px-4 py-2 bg-ink text-white text-sm font-semibold rounded-lg hover:bg-volt shrink-0"
      >Lưu</button>
    </div>
  )
}
